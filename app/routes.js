...
// normal routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
      let produce = [{name:'apples',season:'october'}, {name:'cauliflower',season:'october'}, {name:'pumpkin',season:'october'}, {name:'tangerines',season:'november'}]
      const d = new Date();
...
// message board routes ===============================================================
    ...
    app.delete('/deleteSavedProduce', (req, res) => {
      db.collection('produce').findOneAndDelete({name : req.body.produceName},
        function(err, result){
